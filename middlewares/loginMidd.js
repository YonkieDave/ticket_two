...
const dbUserLogin = require('../app/models/loginUserModel');
    ...
    if(req.body.user != '' && req.body.pass != ''){
        ...
        return next();
            ...
            return(res.render('./login',{
                ...
                alertMessage: "Ingrese ambos campos por favor (usuario y contraseña)",
                alertIcon: 'info',
...
module.exports.userAuth = async (req, res, next) => {
    ...
    if(req.cookies.session_jwt){
        try {
            ...
            let result = await dbUserLogin.userAuth(session);
...
module.exports.validateUserReset = async (req, res, next) => {
    ...
    try {
        if(req.body.userReset != '' && req.body.newPass != ''){
            let result = await dbUserLogin.validateUserResetPass(req.body.userReset);
